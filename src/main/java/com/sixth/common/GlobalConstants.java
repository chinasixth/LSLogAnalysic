...
/**
 * @ Author ：liuhao
 * @ Date   ：Created in 15:14 2018/8/17
 * @
 */
public class GlobalConstants {
    ...
    // 解决向mysql输入汉字变成问号的问题
    public static final String URL = "jdbc:mysql://192.168.216.115:3306/result?useUnicode=true&characterEncoding=utf-8";
    public static final String USERNAME = "root";
    public static final String PASSWORD = "123456";
    public static final String WRITER_PREFIX = "writer_";
    public static final int BATCH_NUMBER = 50;
    public static final long DAY_OF_MILLISECONDS = 24*60*60*1000L;
